import { CHALLENGE_CATEGORIES, CATEGORY_ORDER, categoryFromChallengeId, } from '../../Globetrotter/2026/Categories.js';
const RANGES = {
    users: 'Users!A2:B',
...
export default class GlobetrotterSummary {
    ...
    async getByDiscordId(discordId) {
        ...
        const completedNonRecurring = new Set();
        ...
        for (const row of log) {
            ...
            if (challenge.repeatable)
                recurringSubmissions += 1;
            else
                completedNonRecurring.add(challenge.id);
        }
        const repeatable = [...challengesById.values()]
