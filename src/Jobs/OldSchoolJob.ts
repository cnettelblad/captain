...
export default class OldSchoolJob extends Job {
    ...
    private readonly GUILD_ID = '583718278468206612';
    private readonly OLD_SCHOOL_ROLE_ID = '1462105639428948108';
    private readonly QUALIFYING_ROLE_IDS = [
